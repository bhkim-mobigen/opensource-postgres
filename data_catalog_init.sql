...
INSERT INTO public.tb_menu (menu_id, menu_name, menu_path, parent_menu_id, menu_depth, order_num, menu_visible) VALUES('AS13', '다운로드 이력 조회', '/admin/data/status/downloadHistory', 'A1', 2, 103, true);
INSERT INTO public.tb_menu (menu_id, menu_name, menu_path, parent_menu_id, menu_depth, order_num, menu_visible) VALUES('AS14', '상세조회 이력 조회', '/admin/data/status/searchMetaHistory', 'A1', 2, 104, true);
...
INSERT INTO public.tb_menu_role (menu_id, menu_role_name, order_num) VALUES('AS13', 'ROLE_ADMIN', 103);
INSERT INTO public.tb_menu_role (menu_id, menu_role_name, order_num) VALUES('AS14', 'ROLE_ADMIN', 104);
...
INSERT INTO public.tb_code (parent_id, "level", "name", value, description, "type") VALUES(NULL, NULL, 'MAIN_BANNER_SUBJECT1', '포털 제목1', '메인화면 배너명1', 'portal_config');
INSERT INTO public.tb_code (parent_id, "level", "name", value, description, "type") VALUES(NULL, NULL, 'MAIN_BANNER_SUBJECT2', '포털 제목2', '메인화면 배너명2', 'portal_config');
INSERT INTO public.tb_code (parent_id, "level", "name", value, description, "type") VALUES(NULL, NULL, 'FOOTER_CONTENT1', '하단 설명1', '하단 설명1', 'portal_config');
INSERT INTO public.tb_code (parent_id, "level", "name", value, description, "type") VALUES(NULL, NULL, 'FOOTER_CONTENT2', '하단 설명2', '하단 설명2', 'portal_config');
INSERT INTO public.tb_code (parent_id, "level", "name", value, description, "type") VALUES(NULL, NULL, 'FOOTER_CONTENT3', '하단 설명3', '하단 설명3', 'portal_config');
INSERT INTO public.tb_code (parent_id, "level", "name", value, description, "type") VALUES(NULL, NULL, 'LOGO_IMAGE_FILE_ID', '', '포털 로고 이미지 파일 ID', 'portal_config');
